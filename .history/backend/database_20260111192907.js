...
function initDatabase() {
  ...
  if (workersExist.count === 0) {
    const workers = [
      { id: 'WRK001', name: 'Rajesh Kumar', email: 'rajesh@techfix.com', phone: '+91 9876543210', specialty: 'AC Repair', password: 'worker123' },
      { id: 'WRK002', name: 'Amit Sharma', email: 'amit@techfix.com', phone: '+91 9876543211', specialty: 'Refrigerator', password: 'worker123' },
      { id: 'WRK003', name: 'Priya Singh', email: 'priya@techfix.com', phone: '+91 9876543212', specialty: 'Washing Machine', password: 'worker123' },
    ];
