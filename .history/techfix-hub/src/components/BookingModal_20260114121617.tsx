            ...
            <div className="text-center py-12 space-y-6 animate-in fade-in zoom-in-95 duration-500">
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground max-w-md mx-auto">
                  Our expert team will contact you shortly at <strong>{formData.phone}</strong> to confirm the visit time and provide further details.
                </p>
              </div>
              <div className="p-6 bg-gradient-to-br from-primary/10 to-accent/10 rounded-2xl border border-primary/20 max-w-sm mx-auto">
                <p className="text-sm font-medium text-muted-foreground mb-2">Your Contact Details</p>
                <p className="text-lg font-semibold text-foreground">{formData.name}</p>
                <p className="text-sm text-muted-foreground">{formData.phone}</p>
                <p className="text-xs text-muted-foreground mt-2">We'll call you within 2 hours</p>
              </div>
