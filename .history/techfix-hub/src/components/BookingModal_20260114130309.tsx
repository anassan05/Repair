...
const BookingModal = ({ isOpen, onClose, currentUser }: BookingModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-in fade-in duration-300">
      ...
      {/* Modal */}
      <div className="relative bg-gradient-to-br from-card via-card to-card/95 rounded-3xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-hidden animate-in zoom-in-95 duration-300 border-2 border-primary/10">
        {/* Scrollable Content */}
        <div className="max-h-[90vh] overflow-y-auto scrollbar-thin scrollbar-thumb-primary/20 scrollbar-track-transparent hover:scrollbar-thumb-primary/40">{/* Close Button */}
        <button
          onClick={onClose}
        ...
        <div className="p-6 pt-0">
          ...
          {/* Step 5: Success */}
          {step === 5 && (
            <div className="relative text-center py-16 px-8 space-y-8 animate-in fade-in zoom-in-95 duration-500 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="relative inline-block mb-6">
                  <div className="w-28 h-28 rounded-full gradient-hero flex items-center justify-center mx-auto shadow-2xl animate-in zoom-in duration-700">
                    <Check className="w-14 h-14 text-primary-foreground" />
                  </div>
                  <div className="absolute inset-0 w-28 h-28 rounded-full gradient-hero opacity-20 animate-ping mx-auto" />
                  <div className="absolute -inset-4 rounded-full border-4 border-primary/20 animate-pulse" />
                </div>

                {/* Success Message */}
                <div className="space-y-4 mb-8">
                  <h2 className="text-4xl font-display font-bold bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent animate-in slide-in-from-bottom-4 duration-700">
                    Booking Confirmed! 🎉
                  </h2>
                ...
                <div className="max-w-md mx-auto space-y-4">
                  <div className="p-6 bg-gradient-to-br from-card to-card/50 rounded-2xl border-2 border-primary/20 shadow-xl backdrop-blur-sm">
